    ...
    def add_nums_letters_to_grid(self):
        ...
        for i in range(10):
            ...
            screen.blit(letters_hor, (left_margin + i * block_size + (block_size //
                                                                      2 - letters_hor_width // 2) + self.offset * block_size,
...
def main_menu():
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("assets/Play Rect.png"), pos=(820, 250),
                             text_input="Играть", font=get_font(75), base_color="Black", hovering_color="Red")
        OPTIONS_BUTTON = Button(image=pygame.image.load("assets/Options Rect.png"), pos=(820, 400),
                                text_input="Настройки", font=get_font(75), base_color="Black", hovering_color="Red")
        QUIT_BUTTON = Button(image=pygame.image.load("assets/Quit Rect.png"), pos=(820, 550),
